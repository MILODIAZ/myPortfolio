...
function WelcomeSection () {
  return(
    ...
    <div className='bg-cover bg-center z-0 welcome-section-shadow' style={{ backgroundImage: `url(${welcome_background})` }}>
      ...
      <section id='welcome_section' className='container mx-auto px-12 2xl:px-24 lg:px-19 sm:min-h-[1080px] flex flex-col sm:justify-around items-center'>

        <div>
          <img src={require('../images/neon_monitor.png')} alt='Site-Logo' className='w-60 sm:w-96 mt-40 sm:mt-32 md:mt-18 lg:mt-36 xl:mt-32 2xl:mt-28'/>
        </div>

        <div>
          <h1 className='text-lg sm:text-4xl text-center py-2 text-[#0dcfe5]'>Emilio Díaz</h1>
          <h2 className='text-xs sm:text-xl text-center py-2 text-[#d5a7f2]'>Civil Engineer in Computer Science and Computing</h2>
          <p className='text-[8px] sm:text-sm text-justify py-3 lg:py-7 lg:w-7/12 xl:w-6/12'>Hello and welcome to this incredibly cool and tech-savvy portfolio of
